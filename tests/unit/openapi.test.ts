...
describe('OpenAPI description', () => {
  it('covers exactly the implemented routes and matches the committed document', async () => {
    ...
    expect(paths).toEqual(['/healthz', '/v1/catalog', '/v1/instances', '/v1/instances/{id}', '/v1/operations', '/v1/operations/{id}', '/v1/plans', '/v1/plans/{id}', '/v1/platform-tools', '/v1/platform-tools/{id}', '/v1/sessions', '/v1/sessions/current', '/v1/system']);
