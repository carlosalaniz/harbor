...
describe('OpenAPI description', () => {
  it('covers exactly the implemented routes and matches the committed document', async () => {
    ...
    expect(paths).toEqual(['/healthz', '/v1/account/password', '/v1/appearance', '/v1/appearance/home', '/v1/appearance/rotation', '/v1/appearance/rotation/next', '/v1/appearance/wallpaper', '/v1/catalog', '/v1/catalog/{id}/asset/{name}', '/v1/domains', '/v1/domains/{hostname}', '/v1/domains/{hostname}/check', '/v1/exposures', '/v1/host/folders', '/v1/host/storage', '/v1/instances', '/v1/instances/{id}', '/v1/instances/{id}/appearance', '/v1/instances/{id}/icon', '/v1/operations', '/v1/operations/{id}', '/v1/packages', '/v1/packages/{id}', '/v1/plans', '/v1/plans/{id}', '/v1/platform-tools', '/v1/platform-tools/tailscale/login', '/v1/platform-tools/tailscale/logout', '/v1/platform-tools/{id}', '/v1/sessions', '/v1/sessions/current', '/v1/system', '/v1/system/host', '/v1/system/metrics', '/v1/system/power', '/v1/ui-exposure']);
